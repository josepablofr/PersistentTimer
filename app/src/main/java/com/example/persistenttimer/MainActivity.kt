package com.example.persistenttimer

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.example.persistenttimer.databinding.ActivityMainBinding
import java.util.*
...
class MainActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        {
            stopTimer()
            if(dataHelper.stopTime() != null && dataHelper.stopTime() != null)
            {
